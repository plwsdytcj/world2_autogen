...
PARALLEL_LIMITS = {
    TaskName.DISCOVER_AND_CRAWL_SOURCES: 10,
    TaskName.CONFIRM_LINKS: 10,
    TaskName.PROCESS_PROJECT_ENTRIES: 10,
    TaskName.GENERATE_SEARCH_PARAMS: 10,
    TaskName.RESCAN_LINKS: 10,
    TaskName.FETCH_SOURCE_CONTENT: 10,      # 10 个同时抓取
    TaskName.GENERATE_CHARACTER_CARD: 10,   # 10 个同时生成
    TaskName.REGENERATE_CHARACTER_FIELD: 10,
    TaskName.GENERATE_LOREBOOK_ENTRIES: 10,
}
